...
%
% Modified by Hunki for iceeg data set 
...
function [pval, t_orig, clust_info, seed_state, est_alpha, mn_clust_mass]=clust_perm1_iceeg_sumt(data,chan_hood,n_perm,fwer,tail,thresh_p,verblevel,seed_state,freq_domain)
